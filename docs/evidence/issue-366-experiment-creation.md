...
> Scope correction for Issue #376: these preserved measurements belong to the V1/main-based Issue #366 worktrees (`0a3dd80` baseline and `3d8124c` integration candidate), not the V2 integration. They do not establish V2 creation performance or five original-page acceptance.
