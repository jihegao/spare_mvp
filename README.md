...
- [`docs/superpowers/specs/2026-06-19-m5-2-modeling-import-workbench-design.md`](docs/superpowers/specs/2026-06-19-m5-2-modeling-import-workbench-design.md)：M5.2 建模导入工作台和 Scenario 预览历史设计；当前项目数据管理入口已收敛到项目列表、模板管理、数据概览和 Project JSON 原始数据。
- [`docs/superpowers/plans/2026-06-19-m5-2-modeling-import-workbench.md`](docs/superpowers/plans/2026-06-19-m5-2-modeling-import-workbench.md)：M5.2 系统管理入口、映射/错误/版本预览和 `compile-scenario` 历史实施计划。
...
- [`reports/2026-06-19-page-revision-suggestions/README.md`](reports/2026-06-19-page-revision-suggestions/README.md)：2026-06-19 页面走查建议；其中 M5.2 独立工作台口径已被当前“项目数据管理 / Project 数据层”入口取代。
