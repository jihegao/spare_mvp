...
def _coverage_classification(field_path: str) -> tuple[str, str, str]:
    consumed_prefixes = (
        "importId",
        "projectId",
        "objects.missionProfiles[].durationDays",
        "objects.missionProfiles[].durationHours",
        "objects.missionProfiles[].periodicProfileLists.month[].id",
        "objects.missionProfiles[].periodicProfileLists.month[].weekProfileIds[]",
        "objects.missionProfiles[].periodicProfileLists.week[].id",
        "objects.missionProfiles[].periodicProfileLists.year[].monthProfileIds[]",
        "objects.missionProfiles[].periodicTasks[].compositeTaskIds[]",
        "objects.missionProfiles[].periodicTasks[].compositeTasks[].compositeTaskId",
        "objects.missionProfiles[].periodicTasks[].compositeTasks[].weekday",
        "objects.missionProfiles[].periodicTasks[].id",
