...
const FOCUS_BY_COMPONENT = {
  ...
  "monte-carlo-experiment-list": ["monte-carlo-config", "simulation-run", "run-dataset", "summary-dataset"],
  "monte-carlo-experiment-editor": ["monte-carlo-config", "simulation-run", "run-dataset", "summary-dataset"],
  "monte-carlo-experiment-detail": ["monte-carlo-config", "simulation-run", "run-dataset", "summary-dataset"],
