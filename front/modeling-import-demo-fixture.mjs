export const MODELING_IMPORT_DEMO_FIXTURE = {
  ...
  "objects": {
    ...
    "missionProfiles": [
      {
        ...
        "periodicProfileLists": {
          "month": [
            {
              "id": "month-carrier-day-night",
              "name": "航母昼夜保障月剖面",
              "weekProfileIds": [
                "week-carrier-day-cap",
                "week-carrier-night-alert",
                "",
                ""
              ]
            }
          ...
          "week": [
            {
              "id": "week-carrier-day-cap",
              "name": "第1周昼间制空"
            },
            {
              "id": "week-carrier-night-alert",
              "name": "第2周夜间警戒"
            }
          ],
          "year": [
    ...
    "supportResources": [
      {
        "id": "support-resource-personnel-a1a5ec2fef",
        "model": "",
        "name": "基地",
        "quantity": 5,
        "supportNodeName": "基地",
      ...
      {
        "id": "support-resource-equipment-a1a5ec2fef",
        "model": "甲板保障点",
        "name": "基地",
        "quantity": 3,
        "supportNodeName": "基地",
      ...
      {
        "id": "support-resource-spare-f9224feeb0",
        "model": "发动机备件",
        "name": "发动机备件",
        "quantity": 4,
        "supportNodeName": "基地",
      ...
      {
        "id": "support-resource-spare-17fde32d23",
        "model": "液压备件",
        "name": "液压备件",
        "quantity": 5,
        "supportNodeName": "基地",
      ...
      {
        "id": "support-resource-spare-3c7d67e069",
        "model": "航电模块",
        "name": "航电模块",
        "quantity": 6,
        "supportNodeName": "基地",
      ...
      {
        "id": "support-resource-personnel-b6c153116d",
        "model": "",
        "name": "中继",
        "quantity": 4,
        "supportNodeName": "中继",
      ...
      {
        "id": "support-resource-equipment-b6c153116d",
        "model": "海上保障点",
        "name": "中继",
        "quantity": 2,
        "supportNodeName": "中继",
      ...
      {
        "id": "support-resource-spare-23e10ec846",
        "model": "发动机备件",
        "name": "发动机备件",
        "quantity": 2,
        "supportNodeName": "中继",
      ...
      {
        "id": "support-resource-spare-18b536c487",
        "model": "液压备件",
        "name": "液压备件",
        "quantity": 2,
        "supportNodeName": "中继",
      ...
      {
        "id": "support-resource-spare-5ec05a2507",
        "model": "航电模块",
        "name": "航电模块",
        "quantity": 3,
        "supportNodeName": "中继",
      ...
      {
        "id": "support-resource-personnel-8e051f1445",
        "model": "",
        "name": "基层1",
        "quantity": 3,
        "supportNodeName": "基层1",
      ...
      {
        "id": "support-resource-equipment-8e051f1445",
        "model": "备件库",
        "name": "基层1",
        "quantity": 2,
        "supportNodeName": "基层1",
      ...
      {
        "id": "support-resource-spare-9d11b8cda2",
        "model": "发动机备件",
        "name": "发动机备件",
        "quantity": 6,
        "supportNodeName": "基层1",
      ...
      {
        "id": "support-resource-spare-1e6d61dc33",
        "model": "液压备件",
        "name": "液压备件",
        "quantity": 6,
        "supportNodeName": "基层1",
      ...
      {
        "id": "support-resource-spare-e4529c562d",
        "model": "航电模块",
        "name": "航电模块",
        "quantity": 8,
        "supportNodeName": "基层1",
    ...
    "transportPolicies": [
      {
        ...
        "id": "transport-policy-21ae58b0d0",
        "priority": 1,
        "spareName": "",
      ...
      },
      {
        ...
        "id": "transport-policy-9bbb44d0c0",
        "priority": 1,
        "spareName": "",
      ...
      },
      {
        "capacity": 3,
        "fromSupportNodeName": "基地",
        "id": "transport-policy-0b15cac048",
        "priority": 2,
        "spareName": "",
